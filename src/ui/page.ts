 ...
 *
 * Most of Longhorn's resources are optional in the manifest -- a cluster
 * without backups has no BackupTarget CRD at all -- and a page that asks for
 * one should draw the rest of itself rather than die with "the cluster does
 * not serve crd:backuptargets.longhorn.io".
 */
